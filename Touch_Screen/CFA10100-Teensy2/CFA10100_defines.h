...
//============================================================================
#define EVE_DEVICE           (BT817)//Define the particular EVE chip that we have.
// Include the master (monster) EVE definitions header:
...
// These should have been copied from the debug console when you built with PROGRAM_FLASH_FROM_USD set
...
#define SD_CS       (9) //UnAssigend pin# like in uno
...
#define CLR_EVE_PD_NOT        digitalWrite(EVE_PD_NOT, 0) //(PORTB &= ~(0x01)) 
#define SET_EVE_PD_NOT        digitalWrite(EVE_PD_NOT, 1) //(PORTB |=  (0x01))
#define CLR_EVE_CS_NOT        digitalWrite(EVE_CS_NOT, 0) //(PORTB &= ~(0x02))
#define SET_EVE_CS_NOT        digitalWrite(EVE_CS_NOT, 1) //(PORTB |=  (0x02))
#define CLR_SD_CS_NOT         digitalWrite(SD_CS, 0) //(PORTB &= ~(0x04))
#define SET_SD_CS_NOT         digitalWrite(SD_CS, 1) //(PORTB |=  (0x04))
#define CLR_MOSI              digitalWrite(SPI_MOSI, 0) //(PORTB &= ~(0x08))
#define SET_MOSI              digitalWrite(SPI_MOSI, 1)//(PORTB |=  (0x08)) 
#define CLR_MISO              digitalWrite(SPI_MISO, 0) //(PORTB &= ~(0x10))
#define SET_MISO              digitalWrite(SPI_MISO, 1) //(PORTB |=  (0x10))
#define CLR_SCK               digitalWrite(SPI_SCK, 0) //(PORTB &= ~(0x20))
#define SET_SCK               digitalWrite(SPI_SCK, 1) //(PORTB |=  (0x20))
#define CLR_DEBUG_LED         digitalWrite(DEBUG_LED, 0) //(PORTD &= ~(0x08))
#define SET_DEBUG_LED         digitalWrite(DEBUG_LED, 1) //(PORTD |=  (0x08))
//============================================================================
